...
latex_documents = [(master_doc, "Curve.tex", "Curve Documentation", "Curve.fi", "manual")]
...
man_pages = [(master_doc, "curve", "Curve Documentation", [author], 1)]
